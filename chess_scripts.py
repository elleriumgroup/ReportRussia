...
select
	...
	ifnull(get_mvalue(t.code,{myear_tp},{mperiod},'494',1,3,7),0)  as 'ras_tp',
	ifnull(get_mvalue(t.code,{myear_appg},{mperiod},'494',1,2,7),0)  +
	ifnull(get_mvalue(t.code,{myear_appg},{mperiod},'494',1,3,7),0)  as 'ras_appg',
	...
	ifnull(get_mvalue(t.code,{myear_tp},{mperiod},'494',1,3,17),0) as 'neras_tp',
	...
	ifnull(get_mvalue(t.code,{myear_appg},{mperiod},'494',1,3,17),0) as 'neras_appg'
from
	oblast t
where 
	t.code in ({var_obl})
